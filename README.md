...
- **Windows Update API** - ドライバー更新のインストール

## 主な機能

- **マルチカテゴリ診断**: 以下の主要なデバイスカテゴリを複数同時にスキャン可能
  - オーディオ
  - ディスプレイ
  - ネットワーク
  - Bluetooth
...
1. **カテゴリの選択**: 左側のカテゴリリストから、診断したいデバイスカテゴリをチェックボックスで選択します（複数選択可）。「すべて」をチェックすると全カテゴリが選択されます。
